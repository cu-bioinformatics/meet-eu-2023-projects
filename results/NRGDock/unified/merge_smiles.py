...
file1 = 'top1000_SPH1_SMILES.csv'  # The first CSV file with columns ID, SMILES.
file2 = 'grouped_data_rafi.csv'  # The second CSV file with columns proteinID, ligandID, mean, median, max, min, var.
...
sorted_df.to_csv('unified_results_rafi.csv', index=False)
